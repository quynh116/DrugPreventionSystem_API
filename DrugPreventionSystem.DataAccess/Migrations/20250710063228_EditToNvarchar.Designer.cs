...
namespace DrugPreventionSystem.DataAccess.Migrations
{
    ...
    [Migration("20250710063228_EditToNvarchar")]
    partial class EditToNvarchar
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DrugPreventionSystem.DataAccess.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = 1,
                            CreatedAt = new DateTime(2025, 7, 10, 13, 32, 28, 97, DateTimeKind.Local).AddTicks(5062),
                        ...
                        {
                            RoleId = 2,
                            CreatedAt = new DateTime(2025, 7, 10, 13, 32, 28, 97, DateTimeKind.Local).AddTicks(5094),
                        ...
                        {
                            RoleId = 3,
                            CreatedAt = new DateTime(2025, 7, 10, 13, 32, 28, 97, DateTimeKind.Local).AddTicks(5095),
                        ...
                        {
                            RoleId = 4,
                            CreatedAt = new DateTime(2025, 7, 10, 13, 32, 28, 97, DateTimeKind.Local).AddTicks(5096),
                        ...
                        {
                            RoleId = 5,
                            CreatedAt = new DateTime(2025, 7, 10, 13, 32, 28, 97, DateTimeKind.Local).AddTicks(5097),
            ...
            modelBuilder.Entity("DrugPreventionSystem.DataAccess.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("d649f0f1-3713-47c3-af4a-cac0014f9e9a"),
                            CreatedAt = new DateTime(2025, 7, 10, 13, 32, 28, 234, DateTimeKind.Local).AddTicks(300),
                            Email = "admin@example.com",
                            EmailVerified = true,
                            IsActive = true,
                            PasswordHash = "$2a$11$KVV4cfp.51lASUQU5lIQA.MMvbGiFPh75WkVrsni4EM.nS6is73om",
                            RoleId = 1,
                            Username = "admin_user"
                        },
                        new
                        {
                            UserId = new Guid("7db4b73f-2246-432b-b653-81cddf6263ae"),
                            CreatedAt = new DateTime(2025, 7, 10, 13, 32, 28, 234, DateTimeKind.Local).AddTicks(310),
                        ...
                        new
                        {
                            UserId = new Guid("77eafa7e-5ada-4f43-9de6-03fc52ce2d85"),
                            CreatedAt = new DateTime(2025, 7, 10, 13, 32, 28, 234, DateTimeKind.Local).AddTicks(314),
                        ...
                        new
                        {
                            UserId = new Guid("7bf0c9b7-ca66-43b1-8bea-ebdad750b9a9"),
                            CreatedAt = new DateTime(2025, 7, 10, 13, 32, 28, 234, DateTimeKind.Local).AddTicks(328),
