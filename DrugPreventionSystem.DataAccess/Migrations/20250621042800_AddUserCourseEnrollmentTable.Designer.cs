...
namespace DrugPreventionSystem.DataAccess.Migrations
{
    ...
    [Migration("20250621042800_AddUserCourseEnrollmentTable")]
    partial class AddUserCourseEnrollmentTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DrugPreventionSystem.DataAccess.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = 1,
                            CreatedAt = new DateTime(2025, 6, 21, 11, 27, 58, 838, DateTimeKind.Local).AddTicks(4318),
                        ...
                        {
                            RoleId = 2,
                            CreatedAt = new DateTime(2025, 6, 21, 11, 27, 58, 838, DateTimeKind.Local).AddTicks(4341),
                        ...
                        {
                            RoleId = 3,
                            CreatedAt = new DateTime(2025, 6, 21, 11, 27, 58, 838, DateTimeKind.Local).AddTicks(4344),
                        ...
                        {
                            RoleId = 4,
                            CreatedAt = new DateTime(2025, 6, 21, 11, 27, 58, 838, DateTimeKind.Local).AddTicks(4430),
                        ...
                        {
                            RoleId = 5,
                            CreatedAt = new DateTime(2025, 6, 21, 11, 27, 58, 838, DateTimeKind.Local).AddTicks(4433),
            ...
            modelBuilder.Entity("DrugPreventionSystem.DataAccess.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("12813d0e-e931-43f7-a254-56a66463c628"),
                            CreatedAt = new DateTime(2025, 6, 21, 11, 27, 59, 255, DateTimeKind.Local).AddTicks(6407),
                            Email = "admin@example.com",
                            EmailVerified = true,
                            IsActive = true,
                            PasswordHash = "$2a$11$bfEzuHPU2EImIL0wtiklg.bAz1xw/CWu.BPwWnyeO.NqIVZTHOpWy",
                            RoleId = 1,
                            Username = "admin_user"
                        },
                        new
                        {
                            UserId = new Guid("736133db-9061-4576-b4cc-9a93cc237c91"),
                            CreatedAt = new DateTime(2025, 6, 21, 11, 27, 59, 255, DateTimeKind.Local).AddTicks(6427),
                        ...
                        new
                        {
                            UserId = new Guid("29e967c9-01cb-422a-ba62-9f77fec15b79"),
                            CreatedAt = new DateTime(2025, 6, 21, 11, 27, 59, 255, DateTimeKind.Local).AddTicks(6437),
                        ...
                        new
                        {
                            UserId = new Guid("f45d32b3-1c1b-4193-9683-279a82d96a9f"),
                            CreatedAt = new DateTime(2025, 6, 21, 11, 27, 59, 255, DateTimeKind.Local).AddTicks(6446),
