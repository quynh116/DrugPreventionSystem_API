...
namespace DrugPreventionSystem.DataAccess.Migrations
{
    ...
    [Migration("20250625042303_AddProgramTable")]
            ...
            modelBuilder.Entity("DrugPreventionSystem.DataAccess.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = 1,
                            CreatedAt = new DateTime(2025, 6, 25, 11, 23, 1, 740, DateTimeKind.Local).AddTicks(3153),
                        ...
                        {
                            RoleId = 2,
                            CreatedAt = new DateTime(2025, 6, 25, 11, 23, 1, 740, DateTimeKind.Local).AddTicks(3212),
                        ...
                        {
                            RoleId = 3,
                            CreatedAt = new DateTime(2025, 6, 25, 11, 23, 1, 740, DateTimeKind.Local).AddTicks(3215),
                        ...
                        {
                            RoleId = 4,
                            CreatedAt = new DateTime(2025, 6, 25, 11, 23, 1, 740, DateTimeKind.Local).AddTicks(3217),
                        ...
                        {
                            RoleId = 5,
                            CreatedAt = new DateTime(2025, 6, 25, 11, 23, 1, 740, DateTimeKind.Local).AddTicks(3220),
            ...
            modelBuilder.Entity("DrugPreventionSystem.DataAccess.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("8eb84ac4-3f7d-4532-8201-ea1bbe6cb53f"),
                            CreatedAt = new DateTime(2025, 6, 25, 11, 23, 2, 48, DateTimeKind.Local).AddTicks(5288),
                            Email = "admin@example.com",
                            EmailVerified = true,
                            IsActive = true,
                            PasswordHash = "$2a$11$u.Ltube1u7iljDUX4uM/9eqQRteTus9.fGIJ0JlcXOgrU3FiR2vRu",
                            RoleId = 1,
                            Username = "admin_user"
                        },
                        new
                        {
                            UserId = new Guid("ce4ad697-ae92-48f7-b143-cc0ac147718e"),
                            CreatedAt = new DateTime(2025, 6, 25, 11, 23, 2, 48, DateTimeKind.Local).AddTicks(5302),
                        ...
                        new
                        {
                            UserId = new Guid("44924a66-1181-4270-92d7-677f15e9915b"),
                            CreatedAt = new DateTime(2025, 6, 25, 11, 23, 2, 48, DateTimeKind.Local).AddTicks(5311),
                        ...
                        new
                        {
                            UserId = new Guid("e8efb403-2ffa-4c86-a88a-20bff0200045"),
                            CreatedAt = new DateTime(2025, 6, 25, 11, 23, 2, 48, DateTimeKind.Local).AddTicks(5319),
