...
namespace DrugPreventionSystem.DataAccess.Migrations
{
    ...
    [Migration("20250701160806_AddBlogAndCategories")]
    partial class AddBlogAndCategories
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DrugPreventionSystem.DataAccess.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = 1,
                            CreatedAt = new DateTime(2025, 7, 1, 23, 8, 5, 652, DateTimeKind.Local).AddTicks(8120),
                        ...
                        {
                            RoleId = 2,
                            CreatedAt = new DateTime(2025, 7, 1, 23, 8, 5, 652, DateTimeKind.Local).AddTicks(8156),
                        ...
                        {
                            RoleId = 3,
                            CreatedAt = new DateTime(2025, 7, 1, 23, 8, 5, 652, DateTimeKind.Local).AddTicks(8158),
                        ...
                        {
                            RoleId = 4,
                            CreatedAt = new DateTime(2025, 7, 1, 23, 8, 5, 652, DateTimeKind.Local).AddTicks(8159),
                        ...
                        {
                            RoleId = 5,
                            CreatedAt = new DateTime(2025, 7, 1, 23, 8, 5, 652, DateTimeKind.Local).AddTicks(8160),
            ...
            modelBuilder.Entity("DrugPreventionSystem.DataAccess.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("84233e83-739f-4901-ad79-0ee3ac020a17"),
                            CreatedAt = new DateTime(2025, 7, 1, 23, 8, 5, 761, DateTimeKind.Local).AddTicks(907),
                            Email = "admin@example.com",
                            EmailVerified = true,
                            IsActive = true,
                            PasswordHash = "$2a$11$I3P03LIaVKSaA2zDcJQdY./9TLjabFpOZI3U.VVn3kx.dYPQx98Ku",
                            RoleId = 1,
                            Username = "admin_user"
                        },
                        new
                        {
                            UserId = new Guid("e29f2784-2683-44af-aab5-6a1df890a91a"),
                            CreatedAt = new DateTime(2025, 7, 1, 23, 8, 5, 761, DateTimeKind.Local).AddTicks(917),
                        ...
                        new
                        {
                            UserId = new Guid("27d739e6-3a43-4bdb-b0ab-1d98dded74bc"),
                            CreatedAt = new DateTime(2025, 7, 1, 23, 8, 5, 761, DateTimeKind.Local).AddTicks(920),
                        ...
                        new
                        {
                            UserId = new Guid("10d29045-bfea-4295-bf3a-27a2c6524bcf"),
                            CreatedAt = new DateTime(2025, 7, 1, 23, 8, 5, 761, DateTimeKind.Local).AddTicks(936),
