...
namespace DrugPreventionSystem.DataAccess.Migrations
{
    ...
    [Migration("20250702151648_AddMaxParticipantsToCommunityProgram")]
    partial class AddMaxParticipantsToCommunityProgram
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DrugPreventionSystem.DataAccess.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = 1,
                            CreatedAt = new DateTime(2025, 7, 2, 22, 16, 46, 477, DateTimeKind.Local).AddTicks(6829),
                        ...
                        {
                            RoleId = 2,
                            CreatedAt = new DateTime(2025, 7, 2, 22, 16, 46, 477, DateTimeKind.Local).AddTicks(6853),
                        ...
                        {
                            RoleId = 3,
                            CreatedAt = new DateTime(2025, 7, 2, 22, 16, 46, 477, DateTimeKind.Local).AddTicks(6855),
                        ...
                        {
                            RoleId = 4,
                            CreatedAt = new DateTime(2025, 7, 2, 22, 16, 46, 477, DateTimeKind.Local).AddTicks(6856),
                        ...
                        {
                            RoleId = 5,
                            CreatedAt = new DateTime(2025, 7, 2, 22, 16, 46, 477, DateTimeKind.Local).AddTicks(6857),
            ...
            modelBuilder.Entity("DrugPreventionSystem.DataAccess.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("d553fdc0-8794-425d-93d6-8476a90fd5bd"),
                            CreatedAt = new DateTime(2025, 7, 2, 22, 16, 46, 891, DateTimeKind.Local).AddTicks(9350),
                            Email = "admin@example.com",
                            EmailVerified = true,
                            IsActive = true,
                            PasswordHash = "$2a$11$CSVdsYv41R0zdnEejPMvRO0m0Bq4xA42gsXQAyrmmNelvIKo299D2",
                            RoleId = 1,
                            Username = "admin_user"
                        },
                        new
                        {
                            UserId = new Guid("5b98f9e2-dcc4-482a-b12e-ccf88541de96"),
                            CreatedAt = new DateTime(2025, 7, 2, 22, 16, 46, 891, DateTimeKind.Local).AddTicks(9394),
                        ...
                        new
                        {
                            UserId = new Guid("27df626c-9720-4ebb-b687-e4f3be178d76"),
                            CreatedAt = new DateTime(2025, 7, 2, 22, 16, 46, 891, DateTimeKind.Local).AddTicks(9400),
                        ...
                        new
                        {
                            UserId = new Guid("3250262c-d654-4904-9370-977e4cc9403c"),
                            CreatedAt = new DateTime(2025, 7, 2, 22, 16, 46, 891, DateTimeKind.Local).AddTicks(9406),
