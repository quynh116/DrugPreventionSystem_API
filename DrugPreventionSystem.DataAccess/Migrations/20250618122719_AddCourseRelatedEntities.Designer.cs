...
namespace DrugPreventionSystem.DataAccess.Migrations
{
    ...
    [Migration("20250618122719_AddCourseRelatedEntities")]
    partial class AddCourseRelatedEntities
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DrugPreventionSystem.DataAccess.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = 1,
                            CreatedAt = new DateTime(2025, 6, 18, 19, 27, 18, 701, DateTimeKind.Local).AddTicks(3986),
                        ...
                        {
                            RoleId = 2,
                            CreatedAt = new DateTime(2025, 6, 18, 19, 27, 18, 701, DateTimeKind.Local).AddTicks(4000),
                        ...
                        {
                            RoleId = 3,
                            CreatedAt = new DateTime(2025, 6, 18, 19, 27, 18, 701, DateTimeKind.Local).AddTicks(4001),
                        ...
                        {
                            RoleId = 4,
                            CreatedAt = new DateTime(2025, 6, 18, 19, 27, 18, 701, DateTimeKind.Local).AddTicks(4003),
                        ...
                        {
                            RoleId = 5,
                            CreatedAt = new DateTime(2025, 6, 18, 19, 27, 18, 701, DateTimeKind.Local).AddTicks(4004),
            ...
            modelBuilder.Entity("DrugPreventionSystem.DataAccess.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("669fd5db-893c-46eb-9a18-1b8608f73d29"),
                            CreatedAt = new DateTime(2025, 6, 18, 19, 27, 18, 833, DateTimeKind.Local).AddTicks(632),
                            Email = "admin@example.com",
                            EmailVerified = true,
                            IsActive = true,
                            PasswordHash = "$2a$11$T2sZUHavZAhym.mOqYnSxObC7XC4mVVLwlEjwgeLdULx0PPBB42Y6",
                            RoleId = 1,
                            Username = "admin_user"
                        },
                        new
                        {
                            UserId = new Guid("abedc5db-2621-46f0-b9af-c7e1438d0443"),
                            CreatedAt = new DateTime(2025, 6, 18, 19, 27, 18, 833, DateTimeKind.Local).AddTicks(638),
                        ...
                        new
                        {
                            UserId = new Guid("1e3e644e-0a16-4fcf-a13e-01da8af7fe2e"),
                            CreatedAt = new DateTime(2025, 6, 18, 19, 27, 18, 833, DateTimeKind.Local).AddTicks(641),
                        ...
                        new
                        {
                            UserId = new Guid("580ed3cc-9be3-4fb4-b5b6-2a6c825a2632"),
                            CreatedAt = new DateTime(2025, 6, 18, 19, 27, 18, 833, DateTimeKind.Local).AddTicks(645),
