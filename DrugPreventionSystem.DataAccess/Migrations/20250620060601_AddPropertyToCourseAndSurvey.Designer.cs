...
namespace DrugPreventionSystem.DataAccess.Migrations
{
    ...
    [Migration("20250620060601_AddPropertyToCourseAndSurvey")]
    partial class AddPropertyToCourseAndSurvey
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DrugPreventionSystem.DataAccess.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = 1,
                            CreatedAt = new DateTime(2025, 6, 20, 13, 6, 0, 911, DateTimeKind.Local).AddTicks(3464),
                        ...
                        {
                            RoleId = 2,
                            CreatedAt = new DateTime(2025, 6, 20, 13, 6, 0, 911, DateTimeKind.Local).AddTicks(3477),
                        ...
                        {
                            RoleId = 3,
                            CreatedAt = new DateTime(2025, 6, 20, 13, 6, 0, 911, DateTimeKind.Local).AddTicks(3479),
                        ...
                        {
                            RoleId = 4,
                            CreatedAt = new DateTime(2025, 6, 20, 13, 6, 0, 911, DateTimeKind.Local).AddTicks(3480),
                        ...
                        {
                            RoleId = 5,
                            CreatedAt = new DateTime(2025, 6, 20, 13, 6, 0, 911, DateTimeKind.Local).AddTicks(3482),
            ...
            modelBuilder.Entity("DrugPreventionSystem.DataAccess.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("dedc4d53-6e23-42c1-b30a-9f26ef736102"),
                            CreatedAt = new DateTime(2025, 6, 20, 13, 6, 1, 49, DateTimeKind.Local).AddTicks(4240),
                            Email = "admin@example.com",
                            EmailVerified = true,
                            IsActive = true,
                            PasswordHash = "$2a$11$QTOCZBWg12KGi8SyL0mJ.OR1sdAkGhebmCRcaoh7CHUX6gII7py6K",
                            RoleId = 1,
                            Username = "admin_user"
                        },
                        new
                        {
                            UserId = new Guid("a31fda90-14e5-4f75-a18f-ceded1ac1957"),
                            CreatedAt = new DateTime(2025, 6, 20, 13, 6, 1, 49, DateTimeKind.Local).AddTicks(4247),
                        ...
                        new
                        {
                            UserId = new Guid("d723ae06-ca8a-4cb3-a420-5b68d0ea7a3b"),
                            CreatedAt = new DateTime(2025, 6, 20, 13, 6, 1, 49, DateTimeKind.Local).AddTicks(4259),
                        ...
                        new
                        {
                            UserId = new Guid("9dda1fc6-e4b0-4637-952e-8a6cb2ba02f0"),
                            CreatedAt = new DateTime(2025, 6, 20, 13, 6, 1, 49, DateTimeKind.Local).AddTicks(4262),
