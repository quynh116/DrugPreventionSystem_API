...
namespace DrugPreventionSystem.DataAccess.Migrations
{
    ...
    [Migration("20250626013102_AddContentToLesson")]
    partial class AddContentToLesson
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DrugPreventionSystem.DataAccess.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = 1,
                            CreatedAt = new DateTime(2025, 6, 26, 8, 31, 1, 717, DateTimeKind.Local).AddTicks(2479),
                        ...
                        {
                            RoleId = 2,
                            CreatedAt = new DateTime(2025, 6, 26, 8, 31, 1, 717, DateTimeKind.Local).AddTicks(2527),
                        ...
                        {
                            RoleId = 3,
                            CreatedAt = new DateTime(2025, 6, 26, 8, 31, 1, 717, DateTimeKind.Local).AddTicks(2529),
                        ...
                        {
                            RoleId = 5,
                            CreatedAt = new DateTime(2025, 6, 26, 8, 31, 1, 717, DateTimeKind.Local).AddTicks(2530),
            ...
            modelBuilder.Entity("DrugPreventionSystem.DataAccess.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("c01a681a-bb0f-48b9-9c87-cfa3b11380d8"),
                            CreatedAt = new DateTime(2025, 6, 26, 8, 31, 1, 880, DateTimeKind.Local).AddTicks(890),
                            Email = "admin@example.com",
                            EmailVerified = true,
                            IsActive = true,
                            PasswordHash = "$2a$11$367l6rCe95ld9BD/2FlIyuE3obqEfRms53aADdP4aYecAbLctNWrW",
                            RoleId = 1,
                            Username = "admin_user"
                        },
                        new
                        {
                            UserId = new Guid("c984d4a5-71eb-4442-a0a1-4ab5dbd0f781"),
                            CreatedAt = new DateTime(2025, 6, 26, 8, 31, 1, 880, DateTimeKind.Local).AddTicks(900),
                        ...
                        new
                        {
                            UserId = new Guid("39db358c-4663-4217-ac02-a60ee2d05eb5"),
                            CreatedAt = new DateTime(2025, 6, 26, 8, 31, 1, 880, DateTimeKind.Local).AddTicks(905),
                        ...
                        new
                        {
                            UserId = new Guid("3d09cd51-7a72-4986-b238-35a2530caf28"),
                            CreatedAt = new DateTime(2025, 6, 26, 8, 31, 1, 880, DateTimeKind.Local).AddTicks(927),
