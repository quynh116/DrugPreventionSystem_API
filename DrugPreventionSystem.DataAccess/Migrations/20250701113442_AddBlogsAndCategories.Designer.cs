...
namespace DrugPreventionSystem.DataAccess.Migrations
{
    ...
    [Migration("20250701113442_AddBlogsAndCategories")]
    partial class AddBlogsAndCategories
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DrugPreventionSystem.DataAccess.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = 1,
                            CreatedAt = new DateTime(2025, 7, 1, 18, 34, 40, 204, DateTimeKind.Local).AddTicks(7968),
                        ...
                        {
                            RoleId = 2,
                            CreatedAt = new DateTime(2025, 7, 1, 18, 34, 40, 204, DateTimeKind.Local).AddTicks(7986),
                        ...
                        {
                            RoleId = 3,
                            CreatedAt = new DateTime(2025, 7, 1, 18, 34, 40, 204, DateTimeKind.Local).AddTicks(7987),
                        ...
                        {
                            RoleId = 4,
                            CreatedAt = new DateTime(2025, 7, 1, 18, 34, 40, 204, DateTimeKind.Local).AddTicks(7989),
                        ...
                        {
                            RoleId = 5,
                            CreatedAt = new DateTime(2025, 7, 1, 18, 34, 40, 204, DateTimeKind.Local).AddTicks(7990),
            ...
            modelBuilder.Entity("DrugPreventionSystem.DataAccess.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("d1500a7c-3b87-4b48-a8d5-e0cf0e8ac3df"),
                            CreatedAt = new DateTime(2025, 7, 1, 18, 34, 40, 585, DateTimeKind.Local).AddTicks(3575),
                            Email = "admin@example.com",
                            EmailVerified = true,
                            IsActive = true,
                            PasswordHash = "$2a$11$MhNDpi0jAwePOcXrZQvD7On1garPEQiQv57P4LWpg/f/jq.z4ZZNS",
                            RoleId = 1,
                            Username = "admin_user"
                        },
                        new
                        {
                            UserId = new Guid("15e77e65-8a7d-4b65-ba57-2096de2f4113"),
                            CreatedAt = new DateTime(2025, 7, 1, 18, 34, 40, 585, DateTimeKind.Local).AddTicks(3666),
                        ...
                        new
                        {
                            UserId = new Guid("c88de323-c7e9-49ea-998b-5aa07d7db957"),
                            CreatedAt = new DateTime(2025, 7, 1, 18, 34, 40, 585, DateTimeKind.Local).AddTicks(3670),
                        ...
                        new
                        {
                            UserId = new Guid("56887662-6319-4687-b6ba-193932676e5d"),
                            CreatedAt = new DateTime(2025, 7, 1, 18, 34, 40, 585, DateTimeKind.Local).AddTicks(3673),
